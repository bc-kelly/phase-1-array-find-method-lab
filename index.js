...
function findSuperbowlWin(win) {
    return win.result === 'W';
}

function superbowlWin(record) {
    const yearReturned = record.find(findSuperbowlWin)
    return yearReturned.year;
}
function newWin () {
    const yearReturned = record.find(findSuperbowlWin)
...
// const found = record.find(year => year = 'W');
// console.log(superbowlWin());

// (record.find(findSuperbowlWin) {
//     return ('yes')
// } else {
//     return ('undefined')
// } 
...
//function noWin() {
    //record.indexOf('W')
//}
//const winner = record.indexOf('W')
//console.log(winner);

//console.log(record.find e = e => )

//console.log(record.find(superbowlWin));
//record.find(superbowlWin);

// function add() { return (1 + 3); }
// console.log(add);
